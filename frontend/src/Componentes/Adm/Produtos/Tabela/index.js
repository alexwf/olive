...
export default function EnhancedTable() {
    ...
    pecas.map(peca => (
        rows.push(createData(peca.codigo, peca.nome, peca.categoria, peca.preco, peca.quantidade))
    ));
    ...
    const headCells = [
        ...
        { id: 'calories', numeric: true, disablePadding: false, label: 'Nome' },
        { id: 'fat', numeric: true, disablePadding: false, label: 'Categoria' },
        { id: 'carbs', numeric: true, disablePadding: false, label: 'Preço' },
        { id: 'protein', numeric: true, disablePadding: false, label: 'Quantidade' },
    ];
    ...
    async function handleDeletePecas(codigo) {
        try {
            await api.delete(`pecas/${codigo}`);
            setPecas(pecas.filter(peca => peca.codigo != codigo));
            setSelected([]);
        } catch(err) {
            ...
            >
                ...
                {numSelected > 0 ? (
                        <Typography className={classes.title} color="inherit" variant="subtitle1">
                            {numSelected}{numSelected === 1 ? " peça selecionada" : " peças selecionadas"}
                        </Typography>
                    ) : (
